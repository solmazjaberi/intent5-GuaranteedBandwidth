	...
	implements  Serializable
{
	...
	private  ASIP (  )
	{
		MESSAGES.put( "MSGDEVICECRASHED", generatedbyassl.as.asip.messages.MSGDEVICECRASHED.getInstance() );
		CHANNELS.put( "PUBLIC_LINK", generatedbyassl.as.asip.channels.PUBLIC_LINK.getInstance() );
		FUNCTIONS.put( "SENDDEVICECRASHEDMSG", generatedbyassl.as.asip.functions.SENDDEVICECRASHEDMSG.getInstance() );
	}
