	...
	extends Thread
{
	...
	{
		vPolicies.put( "SELF_HEALING", generatedbyassl.as.autonomicnetwork.asself_management.SELF_HEALING.getInstance() );
		ACTIONS.put( "NOTIFYMANAGEMENT", generatedbyassl.as.autonomicnetwork.actions.NOTIFYMANAGEMENT.getInstance() );
		EVENTS.put( "DEVICECRASHED", generatedbyassl.as.autonomicnetwork.events.DEVICECRASHED.getInstance() );
		EVENTS.put( "MANAGEMENTNOTIFIED", generatedbyassl.as.autonomicnetwork.events.MANAGEMENTNOTIFIED.getInstance() );
		AES.put( "CUSTOMERA", generatedbyassl.as.aes.CUSTOMERA.getInstance() );
		AES.put( "COORDINATOR", generatedbyassl.as.aes.COORDINATOR.getInstance() );
	}
