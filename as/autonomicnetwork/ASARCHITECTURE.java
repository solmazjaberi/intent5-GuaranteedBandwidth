	...
	implements  Serializable
{
	...
	private  ASARCHITECTURE (  )
	{
		...
		//**** adds AELIST
		AELIST.put( "CUSTOMERA", generatedbyassl.as.aes.CUSTOMERA.getInstance() );
		AELIST.put( "COORDINATOR", generatedbyassl.as.aes.COORDINATOR.getInstance() );
		//**** adds DIRECT_DEPENDENCIES
		oDEPENDENCY = new ASSLDEPENDENCY( "CUSTOMERA" );
		oDEPENDENCY.addToDependency( "COORDINATOR", generatedbyassl.as.aes.COORDINATOR.getInstance() );
		DIRECT_DEPENDENCIES.put( "CUSTOMERA", oDEPENDENCY );
		//**** adds TRANSITIVE_DEPENDENCIES
		oDEPENDENCY = new ASSLDEPENDENCY( "COORDINATOR" );
		oDEPENDENCY.addToDependency( "CUSTOMERA", generatedbyassl.as.aes.CUSTOMERA.getInstance() );
		TRANSITIVE_DEPENDENCIES.put( "COORDINATOR", oDEPENDENCY );
		//**** adds GROUPS
		oGROUP = new ASSLGROUP( "DISCOVERY" );
		oGROUP.addToMembers( "CUSTOMERA", generatedbyassl.as.aes.CUSTOMERA.getInstance() );
		oGROUP.addToMembers( "COORDINATOR", generatedbyassl.as.aes.COORDINATOR.getInstance() );
		oGROUP.addToCouncil( "COORDINATOR", generatedbyassl.as.aes.COORDINATOR.getInstance() );
		GROUPS.put( "DISCOVERY", oGROUP );
	}
