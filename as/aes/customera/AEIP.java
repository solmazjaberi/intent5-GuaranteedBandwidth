package generatedbyassl.as.aes.customera;
	...
	implements  Serializable
{
	...
	private  AEIP (  )
	{
		MESSAGES.put( "INTERFACEINACTIVEMSG", generatedbyassl.as.aes.customera.aeip.messages.INTERFACEINACTIVEMSG.getInstance() );
		MESSAGES.put( "RUNSERVICESMSG", generatedbyassl.as.aes.customera.aeip.messages.RUNSERVICESMSG.getInstance() );
		CHANNELS.put( "PRIVATE_LINK", generatedbyassl.as.aes.customera.aeip.channels.PRIVATE_LINK.getInstance() );
		FUNCTIONS.put( "SENDINTERFACEINACTIVEMSG", generatedbyassl.as.aes.customera.aeip.functions.SENDINTERFACEINACTIVEMSG.getInstance() );
		FUNCTIONS.put( "RUNSERVICESMSG", generatedbyassl.as.aes.customera.aeip.functions.RUNSERVICESMSG.getInstance() );
		MANAGED_ELEMENTS.put( "CUSTOMERA", generatedbyassl.as.aes.customera.aeip.managed_elements.CUSTOMERA.getInstance() );
		MANAGED_ELEMENTS.put( "SERVICES", generatedbyassl.as.aes.customera.aeip.managed_elements.SERVICES.getInstance() );
	}
